...
export default function Sidebar() {
  return (
    <aside className="w-64 bg-white text-black h-screen pt-[30px] px-[12px]">
      ...
      <nav>
        <ul className="space-y-6 pt-4">
          <li>
            <Link href="/dashboard">
              <div className="flex row items-center h-[2.5em] gap-3 text-[1.1em] hover:text-black hover:font-bold font-900 text-gray-400  p-2 rounded-md hover:bg-gray-200">
                <RiDashboard3Line className="text-[1.6em]" />
          ...
          <li>
            <Link href="/students">
            <div className="flex row items-center h-[2.5em] gap-3 text-[1.1em] hover:text-black hover:font-bold font-900 text-gray-400  p-2 rounded-md hover:bg-gray-200">
                <RiBookReadFill className="text-[1.6em]" />
          ...
          <li>
            <Link href="/chapter">
            <div className="flex row items-center h-[2.5em] gap-3 text-[1.1em] hover:text-black hover:font-bold font-900 text-gray-400  p-2 rounded-md hover:bg-gray-200">
                <RiBookMarkedLine className="text-[1.6em]" />
          ...
          <li>
            <Link href="/help">
            <div className="flex row items-center h-[2.5em] gap-3 text-[1.1em] hover:text-black hover:font-bold font-900 text-gray-400  p-2 rounded-md hover:bg-gray-200">
                <FaRegQuestionCircle className="text-[1.6em]" />
                <p className="">Help</p>
              </div>
            </Link>
          </li>
          <li>
            <Link href="/reports">
            <div className="flex row items-center h-[2.5em] gap-3 text-[1.1em] hover:text-black hover:font-bold font-900 text-gray-400  p-2 rounded-md hover:bg-gray-200">
                <AiOutlinePieChart className="text-[1.6em]" />
          ...
          <li>
            <Link href="/settings">
            <div className="flex row items-center h-[2.5em] gap-3 text-[1.1em] hover:text-black hover:font-bold font-900 text-gray-400 p-2 rounded-md hover:bg-gray-200">
                <RiSettingsLine className="text-[1.6em]" />
